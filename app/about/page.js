        ...
        <div className="flex flex-col gap-7">
          <div className="w-full border-2 rounded-xl flex flex-col z-20">
            <span className="text-4xl border-b-2 py-6 px-12 w-auto bg-gray-900 rounded-t-xl">
              THE VISION // <span className="text-xl text-orange-500">ver. BETA</span>
            </span>
          ...
          <div className="flex gap-8">
            <div className="w-[40%] border-2 rounded-xl flex flex-col self-start">
              ...
              <div className="p-10 text-xl flex flex-col">
                ...
                <span className="pt-8 font-medium gap-2">
                  Join the waitlist to be one of the first to sign up and create
                  a profile.
                </span>
                    </div>
                <span className="font-bold text-lg py-3 mx-10 mb-6 mt-4 border-white border-[1px] w-[50%] transition-all hover:bg-emerald-900 hover:scale-105 text-[#dfdede] inline-flex justify-center items-center rounded-lg">
                  <a
            ...
            <div className="w-[60%] border-2 rounded-xl flex flex-col">
              <span className="text-4xl border-b-2 py-6 px-12 w-auto bg-cyan-900 rounded-t-xl">
                FUTURE UPDATES
              </span>
              <div className="p-10 text-xl flex flex-col">
                <span>we&apos;re actively working on making our model sharper and smarter</span>
                <span className="pt-4">
                  soon you can expect:
                </span>
