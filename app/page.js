...
export default function Home() {
  ...
  return (
    <div className="flex flex-col h-screen bg-black font-jakarta">
      <img src="/tm-small-logo.png" alt="logo" className="w-[6%] mx-16 mt-5 absolute l-0 b-0" />
      ...
      <div ref={messagesEndRef} className="bg-gray-950 border-t-2 border-opacity-25 border-[#D3CEDC] pb-12 pt-8 w-full">
