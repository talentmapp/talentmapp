...
const MessageForm = ({ onSendMessage }) => {
 ...
 return (
  <>
    <form onSubmit={handleSubmit} className="flex items-center space-x-5 my-24">
      <input
        type="text"
        value={message}
...
<div class="flex items-center py-2 px-3 bg-gray-50 rounded-lg dark:bg-gray-700">
    ...
    <textarea id="chat" rows="1"         type="text"
        value={message}
        onChange={(e) => setMessage(e.target.value)} class="block mx-4 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your message..."></textarea>
